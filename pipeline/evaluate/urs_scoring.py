...
def urs_scoring_prompt(cfg: DictConfig, question: str, gpt4_answer: str, test_answer: str, user_profile: str):
    ...
    grading_criteria = prompt_dict[cfg.task.dataset.user_intention]
    ...
    if cfg.task.dataset.use_user_profile:
...
def urs_scoring(cfg: DictConfig):
    df = pd.read_csv(cfg.task.dataset.path)
    user_intention = cfg.task.dataset.user_intention
    prompt_list = []
    final_result_list = []
    for index, row in df.iterrows():
        ...
        if cfg.task.dataset.use_user_profile:
            ...
            user_profile = ""
        prompt = urs_scoring_prompt(cfg, question, reference_answer, response, user_profile)
